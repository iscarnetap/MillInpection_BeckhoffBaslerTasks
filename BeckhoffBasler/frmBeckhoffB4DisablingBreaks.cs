...
*/
                ...
                if (true || (bool)inv.get(chkSaveFile, "Checked"))
                {
                    try
                    {
                        ...
                        pct1liveTab.Invoke((Action)(() =>
                        {
                            ...
                            using (FileStream file = new FileStream(aPath + "\\Images\\snap" + opt.ToString()+" "+ nFrameMax.ToString() + ".jpg", FileMode.Create, FileAccess.Write, FileShare.Inheritable))
                            {
                                if (chkSaveFile.Checked)
                                {
                                    //pct1liveTab.Image.Save(ms, ici, myEncoderParameters); //jgpEncoder
        ...
        //public int ShowImage(out bool berr, out double yc, out double Angle)
        {
            ...
            if (!bDebugMode) {
                if ((bool)inv.get(chkSaveFile, "Checked")) {
                    ...
                    string fname1 = aPath + "\\Images\\snap" + nOpt.ToString() + " " + nFrameMax1.ToString() + ".jpg";
                ...
                if (nOpt != null && nOpt > 0) frmMainInspect.SnapFile[nOpt - 1] = aPath + "\\Images\\snap" + nOpt.ToString() + " " + nFrameMax.ToString() + ".jpg";
                else frmMainInspect.SnapFile[0] = aPath + "\\Images\\snap" + (1).ToString() + " " + nFrameMax.ToString() + ".jpg";
        ...
        private void chkStretchImage1_CheckedChanged(object sender, EventArgs e)
        {
            if (sender == chkStretchImage1) {
                if (chkStretchImage1.Checked) {
                    ...
                    pct1liveTab.SizeMode =  PictureBoxSizeMode.Zoom;
        ...
        private async void btnStartCycle_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex) { panel1liveTab.Visible = true; }
        }
                    ...
                    if(s != null && s.Length > 2)
                    {
                        switch (s[0])
                        {
                            ...
                            case "cmd95"://start cycle top
                                ...
                                //var task5 = Task.Run(() => frmMainInspect.ImageCycle());//save snaps to images array
                            ...
                            case "cmd84"://front inspect
                                ...
                                {
                                    send = "cmd84,1," + task5.Result.status + ",end";
                                ...
                                break;
                            case "cmd85"://color
                                string sFilePath = aPath + "\\Images\\snap1 16.jpg"; //"C:\\Users\\DeepL\\Documents\\Visual Studio Projects\\ContourIdentification\\Images";
        ...
        //        bStop = false;
        //        //inv.set(btnSatrt2, "Enabled", false);
        //        WC2.SetControls1(txtServer, this, "Cognex", "http://*:5555/");
        ...
        //                switch (s[0])
        //                {
        //                    case "cmd89"://check comm
        //                        send = "cmd89,1,end";
        //                        break;
                            
        //                    case "cmd86"://stop cycle
        //                        bCycle = false;
        //                        send = "cmd86,1,end";

        //                        break;
        //                    case "cmd83"://start sua
        //                        Stopwatch sw1 = new Stopwatch();
        //                        sw1.Restart();
        //                        if (chkCognex.Checked)
        //                        {
        //                            Thread.Sleep(100);
        //                            while (!MyStatic.bReset && sw1.ElapsedMilliseconds < 20000)//wait sua fini
        //                            {
        //                                //if (mFrmMain.lblIndicatorStartStop.Text.Trim() == "done") break;
        //                                //if (frmMain.mFrmMainDefInstance.lblIndicatorStartStop.Text.Trim() == "done") break;
        //                                if (sw1.ElapsedMilliseconds > 60000) break;
        //                                Thread.Sleep(100);
        //                            }

        //                            if (MyStatic.bReset || sw1.ElapsedMilliseconds > 60000)
        //                            {
        //                                send = "cmd83,0,end";
        //                            }
        //                            else
        ...
        private async void btnHome_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var task = Task.Run(() => MoveFooterHome(axis, speed, speed));
                await task;
        ...
        private async void btnWork_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var task = Task.Run(() => MoveFooterWork(axis, Pos5, speed, Pos1, Pos2, Pos4, speed));
                await task;
                if (!task.Result.result)
                {
                    //SetTraficLights(0, 0, 1, 0);//red ight
        ...
        private async Task<CommReply> MoveFooterWork(int axis, Single Pos5, Single speed, Single Pos1, Single Pos2, Single Pos4, Single speed1)//current position
        {
            try
            {
               CommReply reply = new CommReply();
        ...
        public async Task<WebComm.CommReply> InspectFront()
        {
            ...
            try
            {
                ...
                this.Invoke((Action)(() => { frmMainInspect.listBox1.Items.Clear(); }));
                this.Invoke((Action)(() => { frmMainInspect.listBox1.Items.Add("Inspest front start"); }));
