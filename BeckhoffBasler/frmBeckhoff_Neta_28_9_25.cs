...
namespace Inspection
{
    public partial class frmBeckhoff : Form
    {
        ...
        enum eSnapShotStrategy
        {
            ...
            eSnapShotStrategyOnlyHalfImages = 2,
            eSnapShotStrategyOnlyGeographicROIBasedImages = 3,
            eSnapShotStrategyFullImagesForColorHistogramHalfImagesForTheRest = 4,
            eSnapShotStrategyFullImagesForColorHistogramGeographicROIBasedImagesForTheRest = 5
        }
        eSnapShotStrategy _eSnapShotStrategy = eSnapShotStrategy.eSnapShotStrategyFullImagesForColorHistogramHalfImagesForTheRest;
