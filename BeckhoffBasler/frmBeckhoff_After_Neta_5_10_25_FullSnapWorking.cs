...
namespace Inspection
{
    public partial class frmBeckhoff : Form
    {
        ...
        {
            //normal image size is 5320 X 3032
            ConfigureCameraAOI(camera, 0, 0, 5320, 3032);
        }

        void ConfigureHalfImageCameraAOI(Camera camera)
        {
            //normal image size is 5320 X 3032
            ConfigureCameraAOI(camera, 0, 0, 5320, 3032/2);
        }
        ...
        void ConfigureRoiBasedCameraAOI(Camera camera)
        {
            ...
            int iPixelTolerance = 100;
            int iROIRightMostRightValue = frmMainInspect.CalcRightmostCroppingRight(iPixelTolerance);
            int iROIHighestCroppingTop = frmMainInspect.CalcHighestCroppingTop(iPixelTolerance);
            ConfigureCameraAOI(camera, 0, iROIHighestCroppingTop, iROIRightMostRightValue , 3032/2 + iROIRightMostRightValue);
        }
        ...
        void ConfigureCameraAOI(Camera camera, int x, int y, int width, int height)
        {
        ...
        //public int Snap(out int xpar, out int ypar, out int widthpar, out int heightpar, out string sException)
        {
            ...
            try
            {
                ...
                //{
                //    //ConfigureAOI(camera1, 0, 0, 5320, 1516);
                //    ConfigureAOI(camera1, 0, 0, 5320, 3032);
                ...
                bWeldonCycle = false;
                frmMainInspect.StopCycle = true;
                ButtonsEnabled(true); return GetParamsSnap; 
            }
        }
